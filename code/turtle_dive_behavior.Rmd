...
### TO DO: Armando will send new data with 2 hour intervals, remove nesting rows
...
### TO DO: assign dive to interval where > 50% of dive time was spent
...
### TO DO: between each GPS interval

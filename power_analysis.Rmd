...
max_hatchlings <- 30     # maximum number of hatchlings that can be sampled
max_males      <- 5      # maximum number of males females can mate with
...
ggplot(DF, aes(x = Sample_size, y = Proportion_correct, 
  ...
  vline(x = 20, linetype = 2)

# save results to image file
ggsave(plot = last_plot(), filename = 'figure1.png', 
       path = 'C:/Users/Vic/Documents/Projects/iliketurtles',
       width = 5, height = 3)
```

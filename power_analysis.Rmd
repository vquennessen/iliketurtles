...
ggsave(plot = last_plot(), filename = 'eggs_to_sample.png', 
...
png(filename = "C://Users/vique/Documents/Projects/iliketurtles/figures/ss32_conf.png", 
    width = 200, height = 200)
grid.table(DF32)
dev.off()
```

# Print confidence table for sample size of 32

```{r}
print(DF32, row.names = FALSE)
```
